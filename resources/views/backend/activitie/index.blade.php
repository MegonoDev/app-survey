                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input
                                        type="text"
                                        name="kode"
                                        placeholder="Masukan Kode & Enter"
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{  $no++ }}</td>
                                        <td>{!! substr($event->penyelenggara,0,16) !!}...</td>
                                        <td>{!! substr($event->nama_event,0,16) !!}...</td>
                                        ...
                                        <td>
                                            <a href="{{ route ('event.show',$event->id) }}">
                                                <span class="label label-info">{{ $event->members->count() }}
                                                    member</span>
                                            </a>
                                        </td>
                                        <td>
                                            {!! Form::open(['route' => ['event.destroy', $event->id], 'method' =>
                                            'DELETE'])!!}
                                            <a
