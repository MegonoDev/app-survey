  ...
  <div class="row">
    <div class="input-field col s12">
      <div class="form-group {{ $errors->has('handphone') ? 'has-error' : '' }}">
        ...
        {!! Form::number('handphone', null, ['class' => 'form-control', 'placeholder' => '081234567890']) !!} {!! $errors->first('handphone', '
        <p style="color:darkred" class="help-block">:message</p>') !!}
        <span>
  ...
  <div class="row">
    <div class="input-field col s12 l6 m12">
      <div class="form-group {{ $errors->has('id_prov') ? 'has-error' : '' }}">
        ...
        {!! Form::select('id_prov', ['' => 'provinsi']+$provinsi, null, ['class' => 'form-control']) !!} {!!$errors->first('id_prov', '
        <p style="color:darkred" class="help-block">:message</p>') !!}
      </div>
    </div>
    <div class="input-field col s12 l6 m12">
  ...
  <div class="row">
    ...
    <div class="input-field col s12 l6 m12">
      ...
      <div class="form-group {{ $errors->has('perkawinan') ? 'has-error' : '' }}">
          {!! form::select('perkawinan', ['Menikah' => 'Menikah', 'Belum Menikah' => 'Belum Menikah', 'Pisah' => 'Pisah'],null,  ['placeholder' => 'status', 'class' => 'form-control']) !!}
          {!! $errors->first('perkawinan', '<p style="color:darkred" class="help-block">:message</p>') !!}
      </div>
    </div>
    </div>
     <div class="row">
            <div class="input-field col s12 l6 m12">
                ...
                {!! Form::select('organizer_id', ['' => 'Penyelenggara']+$organizers, null, ['class' => 'form-control']) !!}
            ...
            <div class="input-field col s12 l6 m12">
                ...
                {!! Form::select('dealereo_id',	['' => 'AMD/EO'], null, ['class' => 'form-control']) !!}
        ...
        <div class="row">
            <div class="input-field col s12 l6 m12">
                ...
                {!! Form::select('location_id', ['' => 'Lokasi']+$locations, null, ['class' => 'form-control']) !!}
