  ...
  <div class="container-fluid">
    <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Data Event Yamgroup</h4>
      </div>
        ...
        <div class="card-body">
          <form class="form-horizontal form-material">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                @if($kode->status_verifikasi == 0)
                <span class="badge badge-danger">Belum Di Verikasi</span> @else
                <span class="badge badge-info">Sudah Di Verifikasi</span> @endif
              </div>
            </div>
          </form>
          @if( $kode->status_verifikasi == '0')
          <td>
            ...
            {!! Form::submit('Verifikasi Kode', ['class' => 'btn btn-primary']) !!} {!! Form::close() !!}
          </td>
          @endif @endforeach
        </div>
      </div>
